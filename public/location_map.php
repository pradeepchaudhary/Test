...
<?php
    $previous='signature_upload.php';
    $next='prefilled_form.php'; 
...
<?php include ("../php_includes/layout/navigation.php");?>
    <fieldset>
        ...
        <ul type="square">
            <li> Search your place using New Places Box(1st box).</li>
            <li> Click on plot marker and place it on your desired location.</li>
            <li> Enter the Name for your place.</li>
            <li> Click Save place.</li>
        </ul>
    </fieldset>
</nav>
<section>
...
<!--            <label for="search_new_places">New Places</label>-->
            ...
            <input type="text" placeholder="Name Your Place" name="n_place" id="n_place"/>
            </p>
            <p>
            <!--<label for="description">Description</label>-->
            <input type="text" placeholder="Description" name="n_description" id="n_description"/>
            </p>
    ...
    <?php } ?>
        ...
        <script src="javascripts/jquery172.js"></script>
        <script type="text/javascript"
        src="//maps.googleapis.com/maps/api/js?key=AIzaSyD9uiyFbXfbSOsY6umTUtl4_rvl_LkQKxE&sensor=false&libraries=places">
        </script>

        <functions>
            <!--<input type="button" id="finish" value="Finish" onClick="window.location.href='prefilled_form.php'" style="float:right; width:150px"/>-->
